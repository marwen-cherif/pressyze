...
public class Spam {
	...
	private Set<User> denouncers = new HashSet<User>();
	
	public void addDenouncer(User denouncer) {
		denouncers.add(denouncer);
	}
	
	public void removeDenouncer(User denouncer) {
		denouncers.remove(denouncer);
	}
	
	public boolean hasDenouncer(User denouncer) {
		return denouncers.contains(denouncer);
	}

	public Set<User> getDenouncers() {
		return denouncers;
	}

	public void setDenouncers(Set<User> denouncers) {
		this.denouncers = denouncers;
	}
