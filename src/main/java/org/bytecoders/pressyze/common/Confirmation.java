...
public class Confirmation {
	...
	private Set<User> checkers = new HashSet<User>();

	public void addChecker(User checker) {
		checkers.add(checker);
	}

	public void removeChecker(User checker) {
		checkers.remove(checker);
	}

	public boolean hasChecker(User checker) {
		return checkers.contains(checker);
	}

	public Set<User> getCheckers() {
		return checkers;
	}

	public void setCheckers(Set<User> checkers) {
