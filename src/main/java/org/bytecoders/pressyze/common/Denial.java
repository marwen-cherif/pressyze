...
public class Denial {
	...
	private Set<User> deniers = new HashSet<User>();
	
	public void addDenier(User denier) {
		deniers.add(denier);
	}
	
	public void removeDenier(User denier) {
		deniers.remove(denier);
	}
	
	public boolean hasDenier(User denier) {
		return deniers.contains(denier);
	}

	public Set<User> getDeniers() {
		return deniers;
	}

	public void setDeniers(Set<User> deniers) {
		this.deniers = deniers;
	}
