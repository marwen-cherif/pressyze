...
public class AnalyseResponse {
	...
	private long nbConfirmation;
	
	private long nbDenial;
	...
	@XmlElement
	public long getNbConfirmation() {
		return nbConfirmation;
	}

	public void setNbConfirmation(long nbConfirmation) {
		this.nbConfirmation = nbConfirmation;
	}

	@XmlElement
	public long getNbDenial() {
		return nbDenial;
	}

	public void setNbDenial(long nbDenial) {
		this.nbDenial = nbDenial;
	}

	@XmlElement
	public long getNbSpam() {
		return nbSpam;
	}

	public void setNbSpam(long nbSpam) {
		this.nbSpam = nbSpam;
	}
